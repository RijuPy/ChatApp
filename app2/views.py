...
def chat_history(request, room_name):
    ...
    reciver_user = room.user2 if room.user1 == request.user else room.user1
    return JsonResponse({"messages": message_list, "receiver_user":f"{reciver_user.first_name} {reciver_user.last_name}"})
